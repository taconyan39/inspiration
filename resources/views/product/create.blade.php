...
<div id="app" class="container">
    <div class="row">
        <form class="col-4" method="POST" action="{{ route('twitter')}}">
            @csrf
            ...
            <div class="form-group">
                <label>価格</label>
                <input class="form-control" type="text" v-model="price" name="price">
            ...
            <input class="btn btn-primary" type="submit" value="upload">画像をアップロードする
        </form>
    </div>
</div>
