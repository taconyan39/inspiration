        ...
        <ul class="p-pagination">
            ...
            @else
                <li class="p-pagination__items">
                    <a href="{{ $paginator->previousPageUrl() }}" class="p-pagination__items--link" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li class="p-pagination__items">
                    <a class="p-pagination__items--link" href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                </li>
            @else
                <li class="p-pagination__items--disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
