    ...
    <ul v-if="name" class="c-list p-profileSidebar__items">
      ...
      <div class="c-card p-profileSidebar__card--sp">
        ...
        <li class="c-list__item-simple p-profileSidebar__item">
          <a href="" class="c-btn__sidebar c-btn__sub p-profileSidebar__btn">マイページへ</a>
        </li>
        <li class="c-list__item-simple p-profileSidebar__item">
          <a href="" class="c-btn__sidebar c-btn__sub  p-profileSidebar__btn">プロフィール変更</a>
        </li>
        <li class="c-list__item-simple p-profileSidebar__item">
          <a href="" class="c-btn__sidebar c-btn__sub p-profileSidebar__btn">アイデアを<br>投稿する</a>
        </li>
        <li class="c-list__item-simple p-profileSidebar__item">
          <a href="" class="c-btn__sidebar c-btn__sub p-profileSidebar__btn">アイデアを<br>探す</a>
        </li>
      </div>
    </ul>
