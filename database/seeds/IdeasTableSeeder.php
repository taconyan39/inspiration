...
,
        ...
        DB::table('ideas')->insert([
            ...
            $c = mt_rand(2 , 7);
        DB::table('ideas')->insert([
            'title' => 'お金のなる木の育て方', 'price' => $u * 1000 + $c * 100 + $i * 10,
            'summary' => '野島がはじめて杉子に会ったのは帝劇の二階の正',
            'content' => 'メロスは激怒した。必ず、かの邪智暴虐じゃちぼうぎゃくの王を除かなければならぬと決意した。メロスには政治がわからぬ。メロスは、村の牧人である。',
            'user_id' => $u,
            'category_id' => $c,
        ...
        DB::table('ideas')->insert([
            'title' => 'お金のなる木の育て方', 'price' => $u * 1000 + $c * 100 + $i * 10,
            'summary' => '日本では人気がないですが、世界的には人気の高いMOBA（マルチプレイヤーオンラインバトルアリーナ）というジャンルのプロリーグがデキたらいいなと考えています。

            2019年に行われた「The International 2019 Dota2 Championships」では、賞金が約37億円という規模になり、Eスポーツ黎明期の今からビジネスになるのではないかと考えています。',
            'content' => '目的
