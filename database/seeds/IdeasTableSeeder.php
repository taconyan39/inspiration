...
class IdeasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('ideas')->insert([
            ...
            'category_id' => $c,
            'updated_at' => Carbon::now(),
            'updated_at' => Carbon::createFromDate(2020, $i + 4, $i + 5),
        ]);
            }
